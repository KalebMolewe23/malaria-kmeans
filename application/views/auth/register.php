            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    <div class="login-brand">
                        <img src="<?= base_url('assets/img/rmalaria.png') ?>" alt="logo" width="300" class="shadow-light rounded-circle">
                    </div>
                            ...
                            <form method="POST" class="user" action="<?= base_url('auth/register') ?>">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control selectric" name="kabupaten" id="kabupaten">
                                            <option value="Papua Barat">Manokwari</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-6">
                    ...
                    <div class="simple-footer">
                        Copyright &copy; InformasiMalariaPapuaBarat 2020
                    </div>
                </div>
            </div>
        </div>
