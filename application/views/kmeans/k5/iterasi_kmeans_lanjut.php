<section class="home-section">
    ...
    <main>
      <div class="container-fluid">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>kmeans/iterasi_kmeans_k5_lanjut">Proses Iterasi Selanjutnya</a><br><br>
        <?php
          $c1a = "";
          $c1b = "";
          $c1c = "";
...
<table class="table table-bordered table_hover table-striped">
          ...
          <table class="table table-striped data">
            ...
            <tbody>
            <?php 
              foreach($data_malaria_baru->result_array() as $s){ ?>
              <tr>
                  <td><?= $no++; ?></td>
                ...
                <?php
                $q = "insert into centroid_temp_baru(iterasi,idmalaria_baru,c1,c2,c3,c4,c5) values('".$id."','".$s['idmalaria_baru']."','".$arr_c1[$no]."','".$arr_c2[$no]."','".$arr_c3[$no]."','".$arr_c4[$no]."','".$arr_c5[$no]."')";
                $this->db->query($q);
