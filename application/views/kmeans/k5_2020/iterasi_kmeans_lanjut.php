<section class="home-section">
    ...
    <main>
      <div class="container-fluid">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>kmeans/iterasi_kmeans_k5_lanjut_2020">Proses Iterasi Selanjutnya</a><br><br>
        <?php
          $c1a = "";
          $c1b = "";
          $c1c = "";
          ...
          <table class="table table-striped data">
            ...
            <?php 
              ...
              <tr>
                ...
                <?php
                $q = "insert into centroid_temp_k5_baru_2020(iterasi,idmalaria_baru2020,c1,c2,c3,c4,c5) values('".$id."','".$s['idmalaria_baru2020']."','".$arr_c1[$no]."','".$arr_c2[$no]."','".$arr_c3[$no]."','".$arr_c4[$no]."','".$arr_c5[$no]."')";
                $this->db->query($q);
