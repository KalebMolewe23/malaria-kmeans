<section class="home-section">
    ...
    <main>
        ...
        <a class="btn btn-primary" href="<?php echo base_url(); ?>kmeans/iterasi_kmeans_k4_lanjut">Proses Iterasi Selanjutnya</a><br><br>
        <?php
          $c1a = "";
          $c1b = "";
          $c1c = "";
...
<?php
                ...
                <?php
                $q = "insert into centroid_temp_baru(iterasi,idmalaria_baru,c1,c2,c3,c4) values('".$id."','".$s['idmalaria_baru']."','".$arr_c1[$no]."','".$arr_c2[$no]."','".$arr_c3[$no]."','".$arr_c4[$no]."')";
                $this->db->query($q);
