<section class="home-section">
    ...
    <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-home'></i> Iterasi K-4</span>
    </div>
    ...
    <main>
        <div class="container-fluid">
            <div class="container">
                <br>
                <center>
                    <h4><strong>Informasi Perhitungan K-Means K-4</strong></h4>
                </center><br>
            </div>

            <a class="btn btn-primary" href="<?php echo base_url(); ?>kmeans/iterasi_kmeans_k4_lanjut">Proses Iterasi Selanjutnya</a>
            <br><br>

            <?php
            $this->db->query('truncate table centroid_k4_awal');
            ...
            $q = "insert into centroid_k4_awal(idmalaria_c1, idmalaria_c2, idmalaria_c3, idmalaria_c4) values('".$data_c1."','".$data_c2."','".$data_c3."','".$data_c4."')";
            $this->db->query($q);

            // data centroid 1
            $this->db->where('idmalaria_c1', $data_c1);
            $this->db->join('data_malaria_baru', 'data_malaria_baru.idmalaria_baru = centroid_k4_awal.idmalaria_c1');
            $data_centroid1 = $this->db->get('centroid_k4_awal');
            ...
            $this->db->join('data_malaria_baru', 'data_malaria_baru.idmalaria_baru = centroid_k4_awal.idmalaria_c2');
            $data_centroid2 = $this->db->get('centroid_k4_awal');
            ...
            $this->db->join('data_malaria_baru', 'data_malaria_baru.idmalaria_baru = centroid_k4_awal.idmalaria_c3');
            $data_centroid3 = $this->db->get('centroid_k4_awal');
            ...
            $this->db->join('data_malaria_baru', 'data_malaria_baru.idmalaria_baru = centroid_k4_awal.idmalaria_c4');
            $data_centroid4 = $this->db->get('centroid_k4_awal');
          ...
          <div class="table-responsive">
            <table class="table table-striped data">
              ...
              <?php foreach ($cluster->result_array() as $s) { ?>
                ...
                $q = "insert into centroid_temp_baru(iterasi,idmalaria_baru,c1,c2,c3,c4) values(1,'".$s['idmalaria_baru']."','".$arr_c1[$no]."','".$arr_c2[$no]."','".$arr_c3[$no]."','".$arr_c4[$no]."')";
                $this->db->query($q);
                ...
                $q = "insert into hasil_centroid_baru(c1a,c1b,c1c,c1d,c1e,c1f,c1g,c1h,c1i,c1j,c1k,c1l,c1m,c2a,c2b,c2c,c2d,c2e,c2f,c2g,c2h,c2i,c2j,c2k,c2l,c2m,c3a,c3b,c3c,c3d,c3e,c3f,c3g,c3h,c3i,c3j,c3k,c3l,c3m,c4a,c4b,c4c,c4d,c4e,c4f,c4g,c4h,c4i,c4j,c4k,c4l,c4m) values('".$c1a_b."','".$c1b_b."','".$c1c_b."','".$c1d_b."','".$c1e_b."','".$c1f_b."','".$c1g_b."','".$c1h_b."','".$c1i_b."','".$c1j_b."','".$c1k_b."','".$c1l_b."','".$c1m_b."','".$c2a_b."','".$c2b_b."','".$c2c_b."','".$c2d_b."','".$c2e_b."','".$c2f_b."','".$c2g_b."','".$c2h_b."','".$c2i_b."','".$c2j_b."','".$c2k_b."','".$c2l_b."','".$c2m_b."','".$c3a_b."','".$c3b_b."','".$c3c_b."','".$c3d_b."','".$c3e_b."','".$c3f_b."','".$c3g_b."','".$c3h_b."','".$c3i_b."','".$c3j_b."','".$c3k_b."','".$c3l_b."','".$c3m_b."','".$c4a_b."','".$c4b_b."','".$c4c_b."','".$c4d_b."','".$c4e_b."','".$c4f_b."','".$c4g_b."','".$c4h_b."','".$c4i_b."','".$c4j_b."','".$c4k_b."','".$c4l_b."','".$c4m_b."')";
                $this->db->query($q);
