...
<section>
    <div class="container">
        ...
        <center><a href="<?= base_url("admin/data_malaria"); ?>"><button class="btn btn-success" type="button"><i class="fas fa-plus"></i> Tambah Data</button></a></center>
        <br>
        ...
        <table class="table table-bordered table_hover table-striped">
            ...
            foreach ($malaria as $inv) : ?>
                <tr>
                    ...
                    <td align="center">
                        <?= anchor('admin/editmalaria/' . $inv->id_malaria, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Ubah</div>') ?>
                        <?= anchor('admin/deletedatamalaria/' . $inv->id_malaria, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus</div>') ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
