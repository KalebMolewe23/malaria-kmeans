...
<section>
    <div class="container">
        <br>
        <center>
            <h4><strong>Informasi Data Malaria </strong></h4>
        </center><br>

        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut"); ?>"><i class="fas fa-spinner"></i> Proses Iterasi Selanjutnya</a></br></br>
        ...
        <div class="table-responsive">
            <table id="table_data" class="table table-bordered table-admin">
                ...
                <?php
                    $q = "insert into centroid_temp(id_malaria,iterasi,c1,c2,c3) values('" . $s['id_malaria'] . "','" . $id . "','" . $arr_c1[$no] . "','" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                    $this->db->query($q);
