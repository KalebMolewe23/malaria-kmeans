...
<section>
    <div class="container">
        ...
        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut"); ?>"><i class="fas fa-spinner"></i> Proses Iterasi Selanjutnya</a></br>
        </br>
        <table id="table_data" class="table table-bordered table_hover table-striped">
            ...
            <?php
                ...
                $q = "insert into centroid_temp(id_malaria,iterasi,c1,c2,c3) values('" . $s->id_malaria . "',1,'" . $arr_c1[$no] . "','" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                $this->db->query($q);
