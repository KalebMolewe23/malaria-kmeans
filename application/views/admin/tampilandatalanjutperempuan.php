...
<section>
    <div class="container">
        ...
        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut_perempuan"); ?>"><i class="fas fa-spinner"></i> Proses Iterasi Selanjutnya</a></br></br>
        ...
        <div class="table-responsive">
            <table id="table_data" class="table table-bordered table-admin">
                ...
                <?php
                foreach ($data_malaria->result_array() as $s) { ?>
                    <tr>
                ...
                <?php
                    $q = "insert into centroid_temp_perempuan(id_malaria,iterasi,c1,c2,c3) values('" . $s['id_malariap'] . "','" . $id . "','" . $arr_c1[$no] . "','" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                    $this->db->query($q);
