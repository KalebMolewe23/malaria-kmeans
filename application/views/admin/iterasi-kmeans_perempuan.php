...
<section>
    <div class="container">
        <br>
        <center>
            <h4><strong>Informasi Data Malaria Perempuan </strong></h4>
        </center><br>

        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut_perempuan"); ?>"><i class="fas fa-spinner"></i> Proses Iterasi Selanjutnya</a></br>
        </br>
        <table id="table_data" class="table table-bordered table_hover table-striped">
            ...
            $this->db->query('truncate table centroid_temp_perempuan');
            $this->db->query('truncate table hasil_centorid_perempuan');
            foreach ($malaria as $s) { ?>
                <tr>
                    <td><?php echo $s->id_malariap; ?></td>
            ...
            <?php
                ...
                $q = "insert into centroid_temp_perempuan(id_malaria,iterasi,c1,c2,c3) values('" . $s->id_malariap . "',1,'" . $arr_c1[$no] . "','" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                $this->db->query($q);
            ...
            $q = "insert into hasil_centorid_perempuan(c1a,c1b,c1c,c2a,c2b,c2c,c3a,c3b,c3c) values('" . $c1a_b . "','" . $c1b_b . "','" . $c1c_b . "','" . $c2a_b . "','" . $c2b_b . "','" . $c2c_b . "','" . $c3a_b . "','" .
                $c3b_b . "','" . $c3c_b . "')";
            $this->db->query($q);
