...
<section>
    <div class="container">
        ...
        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut_laki"); ?>"><i class="fas fa-spinner"></i> Proses Iterasi Selanjutnya</a></br></br>
        ...
        <div class="table-responsive">
            <table id="table_data" class="table table-bordered table-admin">
                ...
                <?php
                    $q = "insert into centroid_temp_laki(id_malaria,iterasi,c1,c2,c3) values('" . $s['id_malarial'] . "','" . $id . "','" . $arr_c1[$no] . "','" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                    $this->db->query($q);
