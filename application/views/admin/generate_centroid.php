...
<section>
    <div class="container">
        <br>
        <center>
            <h4><strong>Informasi Data Centroid Malaria Kab. Monokwari </strong></h4>
        </center><br>

        <a class="btn btn-primary" href="<?= base_url("admin/tampilan_data"); ?>"><i class="fas fa-backspace"></i> Kembali</a>&nbsp;<a class="btn btn-success" href="<?= base_url("admin/iterasi_kmeans"); ?>"><i class="fas fa-spinner"></i> Proses K-Means</a></br>
        </br>
