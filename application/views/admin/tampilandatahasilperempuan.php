...
<section>
    <div class="container">
        ...
        <div id="body">
            <a class="btn btn-success" href="<?= base_url("admin/grafik_perempuan"); ?>"><i class="fas fa-chart-pie"></i> Grafik Malaria</a><br>
            <?php
            ...
            ?>
                ...
                <div class="table-responsive">
                    <table id="table_data" class="table table-bordered table-admin">
                        ...
                        <?php
                        $q2 = $this->db->query('select * from centroid_temp_perempuan where iterasi=' . $hq['iterasi'] . '');
