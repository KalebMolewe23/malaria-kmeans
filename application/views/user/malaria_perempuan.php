...
<section>
    <div class="container">
        ...
        <br>
        <a href="<?= base_url("user/print_data_malaria_perempuan"); ?>"><button class="btn btn-primary" type="button"><i class="fas fa-print"></i> Print</button></a>&nbsp;
        ...
        <a class="btn btn-success" href="<?= base_url("user/grafik_perempuan"); ?>"><i class="fas fa-chart-pie"></i> Grafik Malaria</a>
        <br><br>
