...
<div class="container">
    ...
    <br>
    <a href="<?= base_url("user/data_malaria"); ?>"><button class="btn btn-success" type="button"><i class="fas fa-backspace"></i> Kembali</button></a>&nbsp;<a class="btn btn-primary" href="<?= base_url("user/print_grafik") ?>"><i class="fas fa-print"></i> Print</a><br><br>
