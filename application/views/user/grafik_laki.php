...
<div class="container">
    ...
    <br>
    <a href="<?= base_url("user/data_malaria_laki"); ?>"><button class="btn btn-success" type="button"><i class="fas fa-backspace"></i> Kembali</button></a>&nbsp;<a class="btn btn-primary" href="<?= base_url("user/print_grafik_laki") ?>"><i class="fas fa-print"></i> Print</a><br><br>
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ...
            foreach ($malaria as $v) {
                echo "['" . $v['predikat'] . "'," . $v['total_laki'] . "],";
            }
            ?>
        ]);
        var options = {
            title: 'Data Malaria Laki-Laki Kab. Monokwari',
            is3D: true,
        };
