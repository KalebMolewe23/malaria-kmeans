<section class="home-section">
    ...
    <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-home'></i> Data Malaria Zona Kuning 2019</span>
    </div>
    ...
    <main>
      <div class="container">
        <div align="center">
          ...
          <a href="<?= base_url('administrator/dashboard/zona_merah_2019'); ?>"><button type="submit" class="btn btn-danger">Zona Bahaya</button></a>&nbsp;&nbsp;
          <a href="<?= base_url('administrator/dashboard/zona_kuning_2019'); ?>"><button type="submit" class="btn btn-alert">Zona Waspada</button></a>&nbsp;&nbsp;
          <a href="<?= base_url('administrator/dashboard/zona_hijau_2019'); ?>"><button type="submit" class="btn btn-success">Zona Aman</button></a>
        </div>
      </div>
