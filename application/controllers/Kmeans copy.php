...
class Kmeans extends CI_Controller
{
    ...
    {
        $data['malaria'] = $this->db->get('data_kmeans_k2');
		$id = "";
		...
		$data['centroid'] = $this->db->get('hasil_centroid_k2');
		$data['id'] = $id+1;
		...
		else
		{
            ...
            $this->load->view('kmeans/k2/tampilandatalanjut', $data);
            $this->load->view('layout/footer');
		}
	}
    ...
    public function iterasi_k3()
    {
        ...
        $datakmeans['kmeans'] = $this->db->get('data_kmeans_k3');
    ...
    {
        $data['malaria'] = $this->db->get('data_kmeans_k3');
		$id = "";
		...
		$data['centroid'] = $this->db->get('hasil_centroid_k3');
		$data['id'] = $id+1;
		...
		else
		{
			...
			$this->load->view('layout/header', $datas);
            $this->load->view('kmeans/k3/tampilandatalanjut', $data);
            $this->load->view('layout/footer');
		}
	}
    ...
    function iterasi_hasil_k3()
    {
        ...
        $this->db->join('data_kmeans_k3', 'data_kmeans_k3.iddata_kmeans_k3 = centroid_temp_k3.iddata_kmeans_k3');
        $this->db->join('data_malaria', 'data_malaria.id_malaria = data_kmeans_k3.id_malaria');
        $this->db->join('puskesmas', 'puskesmas.id_puskesmas = data_malaria.id_puskesmas');
